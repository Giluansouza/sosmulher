...
<div class="row">
    <div class="col-xl-12">
        <div class="breadcrumb-holder">
            <h1 class="main-title float-left text-white">Botão do Pânico</h1>
            <ol class="breadcrumb float-right">
                <li class="breadcrumb-item text-white">Início</li>
                <li class="breadcrumb-item active text-white">Botão do Pânico</li>
            </ol>
